...
def active_parser_class():
    return parser.GenericCCXTPositionsParser(exchange=mock_abstract_exchange())
...
def get_raw_closed_positions():
    return [
        {
            ExchangePositionCCXTColumns.INFO.value: {
                "user_id": "285169",
                "symbol": "10000NFTUSDT",
                "side": "None",
                "size": "0",
            ...
            ExchangePositionCCXTColumns.ID.value: None,
            ExchangePositionCCXTColumns.SYMBOL.value: "10000NFT/USDT:USDT",
            ExchangePositionCCXTColumns.TIMESTAMP.value: 1668494270,
            ExchangePositionCCXTColumns.DATETIME.value: None,
            ExchangePositionCCXTColumns.INITIAL_MARGIN.value: None,
            ExchangePositionCCXTColumns.INITIAL_MARGIN_PERCENTAGE.value: None,
            ExchangePositionCCXTColumns.MAINTENANCE_MARGIN.value: None,
            ExchangePositionCCXTColumns.MAINTENANCE_MARGIN_PERCENTAGE.value: None,
            ExchangePositionCCXTColumns.ENTRY_PRICE.value: None,
            ExchangePositionCCXTColumns.NOTIONAL.value: 0.0,
            ExchangePositionCCXTColumns.LEVERAGE.value: 5.0,
            ExchangePositionCCXTColumns.UNREALIZED_PNL.value: None,
            ExchangePositionCCXTColumns.CONTRACTS.value: 0.0,
            ExchangePositionCCXTColumns.CONTRACT_SIZE.value: 1.0,
            ExchangePositionCCXTColumns.MARGIN_RATIO.value: None,
            ExchangePositionCCXTColumns.LIQUIDATION_PRICE.value: None,
            ExchangePositionCCXTColumns.MARK_PRICE.value: None,
            ExchangePositionCCXTColumns.COLLATERAL.value: 0.0,
            ExchangePositionCCXTColumns.MARGIN_MODE.value: "cross",
            ExchangePositionCCXTColumns.SIDE.value: "short",
            ExchangePositionCCXTColumns.PERCENTAGE.value: None,
        }
    ]
    ...
    return [
        {
            ...
            ExchangePositionCCXTColumns.ID.value: None,
            ExchangePositionCCXTColumns.SYMBOL.value: "BTC/USDT:USDT",
            ExchangePositionCCXTColumns.TIMESTAMP.value: 1668494270,
            ExchangePositionCCXTColumns.DATETIME.value: None,
            ExchangePositionCCXTColumns.INITIAL_MARGIN.value: 33.59393785384,
            ExchangePositionCCXTColumns.INITIAL_MARGIN_PERCENTAGE.value: 0.19999999998714055,
            ExchangePositionCCXTColumns.MAINTENANCE_MARGIN.value: None,
            ExchangePositionCCXTColumns.MAINTENANCE_MARGIN_PERCENTAGE.value: None,
            ExchangePositionCCXTColumns.ENTRY_PRICE.value: 16796.96892692,
            ExchangePositionCCXTColumns.NOTIONAL.value: 167.96968928,
            ExchangePositionCCXTColumns.LEVERAGE.value: 5.0,
            ExchangePositionCCXTColumns.UNREALIZED_PNL.value: 2.50941072,
            ExchangePositionCCXTColumns.CONTRACTS.value: 0.01,
            ExchangePositionCCXTColumns.CONTRACT_SIZE.value: 1.0,
            ExchangePositionCCXTColumns.MARGIN_RATIO.value: None,
            ExchangePositionCCXTColumns.LIQUIDATION_PRICE.value: 13522.0,
            ExchangePositionCCXTColumns.MARK_PRICE.value: None,
            ExchangePositionCCXTColumns.COLLATERAL.value: 33.5939353,
            ExchangePositionCCXTColumns.MARGIN_MODE.value: "isolated",
            ExchangePositionCCXTColumns.SIDE.value: "long",
            ExchangePositionCCXTColumns.PERCENTAGE.value: 7.469832000398127,
        }
    ]
    ...
    return [
        {
            ...
            PositionCols.SINGLE_CONTRACT_VALUE.value: decimal.Decimal('1.0'),
        }
    ]
    ...
    return [
        {
            ...
            PositionCols.INITIAL_MARGIN.value: decimal.Decimal("33.59393785384"),
...
async def test_parse_one_way_mode(
    parsed_open_positions=None,
    parsed_closed_positions=None,
    raw_open_positions=None,
    raw_closed_positions=None,
):
    parsed_open_positions=deepcopy(parsed_open_positions or get_parsed_open_positions()) 
    parsed_closed_positions=deepcopy(parsed_closed_positions or get_parsed_closed_positions()) 
    raw_open_positions=deepcopy(raw_open_positions or get_raw_open_positions()) 
    raw_closed_positions=deepcopy(raw_closed_positions or get_raw_closed_positions()) 
...
async def hedge_mode_test(
    ...
    parsed_open_positions = deepcopy(parsed_open_positions)
    parsed_closed_positions = deepcopy(parsed_closed_positions)
    raw_open_positions = deepcopy(raw_open_positions)
    raw_closed_positions = deepcopy(raw_closed_positions)
    await set_and_check_open_and_closed(
        active_parser=active_parser,
        key=PositionCols.POSITION_MODE.value,
...
async def test_parse_position_missing_mode(
    ...
    _raw_closed_positions = deepcopy(raw_closed_positions or get_raw_closed_positions())
    _raw_open_positions = deepcopy(raw_open_positions or get_raw_open_positions())
    try:
