...
packages_list = [
    ...
    "octobot_trading.exchanges.parser.market_status_parser",
    "octobot_trading.exchanges.parser.orders_parser",
    "octobot_trading.exchanges.parser.trades_parser",
    "octobot_trading.exchanges.parser.positions_parser",
